...
void lcdLoadCustomChar(u8 romCharNum, u8 lcdCharNum);
//void lcdLoadCustomChar(u8* lcdCustomCharArray, u8 romCharNum, u8 lcdCharNum);
...
void lcdProgressBar(u16 progress, u16 maxprogress, u8 length);
